...
```mermaid
flowchart TD
    A["Round glass<br/>makes Magic talk"] --> B["Chalk<br/>→ myriad shells"]
    A --> C["Moss<br/>→ forest of flowers and trees"]
    A --> D["Water drop<br/>→ hive of bees"]
    A --> E["Spider<br/>→ web-silk from spinnerets"]
    E --> F["Tigerish claws<br/>+ silly flies"]
    A --> G["Strong lenses<br/>→ moon within reach"]
```
